...
result = maximize(testit_dict, num_evals=10000, solver_name="nelder-mead", x=[-5,5], y=[-5,5], z=[-5,5])

@test_approx_eq_eps result[1]["x"]  0.8 .1
@test_approx_eq_eps result[1]["y"]  1.9 .1
@test_approx_eq_eps result[1]["z"] -3.4 .1