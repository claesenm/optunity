...
if nm_available
    ...
    [nm_solution, nm_optimum, nm_nevals, nm_time, nm_log] = ...
...
[constr_solution, constr_optimum, constr_nevals, constr_time, constr_log] = ...
...
call_log = struct('args',struct('x',[1 1 2 2], 'y', [1 2 1 2]), ...
    'values',[1 2 3 4]);
[warm_solution, warm_optimum, warm_nevals, warm_time, warm_log] = ...    
    optunity.solve('grid-search', solver_config, f, ...
