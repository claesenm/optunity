function [solution, details] = optunity_optimize( solver, f, varargin)
%OPTIMIZE: Optimizes f using the given solver and extra options.
%
% This function accepts the following arguments:
% - solver: an Optunity solver, as generated by optunity_make_solver()
...
defaults = struct('maximize', true, 'max_evals', 0, ...
    ...
    'default', NaN, ...
    'parallelize', false);
options = optunity_process_varargin(defaults, varargin, true);
