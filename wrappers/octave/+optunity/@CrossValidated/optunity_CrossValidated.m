    ...
    methods
        ...
        function folds = get_folds(obj)
            ...
            if obj.regenerate_folds || isempty(obj.current_folds)
                obj.current_folds = optunity_generate_folds(size(obj.x, 1), 'num_folds', obj.num_folds, ...
        ...
        function cv = set_fun(obj, fun)
            cv = optunity_CrossValidated(fun, obj.x, obj.y, obj.strata, obj.clusters, ...
