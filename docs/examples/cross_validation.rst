...
:func:`optunity.cross_validation.cross_validated` for implementation and API details.
...
The inner :func:`optunity.cross_validation.cross_validated` decorator has access to
